...
const MUSEE_MYTHOLOGIE_OBJECTS = [
  {
    ...
    fact: "Le douzième et dernier travail d'Hercule consiste à ramener vivant Cerbère, le chien à trois têtes des Enfers, sans utiliser aucune arme.",
  ...
  },
  {
    ...
    fact: "Ce n'est pas l'Iliade d'Homère qui raconte la ruse du cheval, mais l'Odyssée et surtout l'Énéide de Virgile.",
  ...
  },
  {
    ...
    fact: "La toison recherchée par Jason est celle d'un bélier ailé et doré, capable à la fois de voler et de parler.",
  ...
  },
  {
    ...
    fact: "Chaque dieu grec correspond à un dieu romain équivalent mais avec un nom différent : Zeus devient Jupiter, Athéna devient Minerve.",
  ...
  },
  {
    ...
    fact: "Après la mort de Méduse, le cheval ailé Pégase serait né du sang qui a coulé de son cou tranché.",
  ...
  },
  {
    ...
    fact: "Dédale avait pourtant averti son fils de ne voler ni trop haut (le soleil) ni trop bas (l'humidité de la mer) — Icare n'a écouté qu'à moitié.",
  ...
  },
  {
    ...
    fact: "Une seule chose serait restée au fond de la boîte avant que Pandore ne la referme : l'espérance.",
  ...
  },
  {
    ...
    fact: "Le mot « narcissique », utilisé aujourd'hui en psychologie pour une personne amoureuse de son image, vient directement de ce mythe.",
  ...
  },
  {
    ...
    fact: "Le mot « arachnide », qui désigne aujourd'hui les araignées, vient directement du nom d'Arachné.",
  ...
  },
  {
    ...
    fact: "Dans le mythe original, les Sirènes ne sont pas des femmes-poissons mais des femmes-oiseaux : la queue de poisson est une image plus tardive.",
  ...
  },
  {
    ...
    fact: "Les 12 signes du zodiaque utilisés en astrologie viennent eux aussi des constellations identifiées par les astronomes grecs il y a plus de 2000 ans.",
  ...
  },
  {
    ...
    fact: "L'auteur de Percy Jackson, Rick Riordan, a d'abord inventé ces histoires pour aider son propre fils, dyslexique, à se réconcilier avec la lecture.",
  ...
  },
  {
    ...
    fact: "Le kraken, la créature marine géante du film, ne vient pas de la mythologie grecque : c'est une légende scandinave, ajoutée librement par les scénaristes.",
