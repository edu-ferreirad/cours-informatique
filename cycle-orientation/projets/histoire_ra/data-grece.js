...
const MUSEE_GRECE_OBJECTS = [
  {
    ...
    fact: "Le mot « politique » vient du grec polis, qui signifie « cité ».",
  ...
  },
  {
    ...
    fact: "Les femmes ne participaient pas aux Jeux : elles avaient leurs propres compétitions, les Héraia, dédiées à la déesse Héra.",
  ...
  },
  {
    ...
    fact: "La trêve durait environ trois mois, pour laisser aux athlètes venus de très loin le temps de voyager sans danger jusqu'à Olympie.",
  ...
  },
  {
    ...
    fact: "Le Parthénon a servi tour à tour de temple, d'église, de mosquée puis de poudrière — une explosion en 1687 a détruit une grande partie de sa toiture.",
  ...
  },
  {
    ...
    fact: "Sur environ 40 000 habitants d'Athènes, seuls les hommes libres nés de parents athéniens votaient : ni les femmes, ni les esclaves, ni les étrangers n'étaient citoyens.",
  ...
  },
  {
    ...
    fact: "Les athlètes concouraient nus — le mot « gymnase » vient du grec gymnos, qui signifie justement « nu ».",
  ...
  },
  {
    ...
    fact: "L'expression « par Zeus ! », utilisée par les Grecs pour marquer la surprise ou la colère, est encore reprise aujourd'hui dans des films et des bandes dessinées.",
  ...
  },
  {
    ...
    fact: "À Sparte, les garçons quittaient leur famille dès 7 ans pour vivre en caserne et s'entraîner jusqu'à 30 ans.",
  ...
  },
  {
    ...
    fact: "Le théâtre d'Épidaure a une acoustique si parfaite qu'une pièce de monnaie lâchée sur la scène s'entend depuis les derniers rangs, 60 mètres plus haut.",
  ...
  },
  {
    ...
    fact: "Le mot « alphabet » vient lui-même des deux premières lettres grecques : alpha et bêta.",
