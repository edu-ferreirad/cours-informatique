...
const ArXR = (() => {
  ...
  async function exploreChapter({ canvas, overlayRoot, anchors, onCalibrated, onCorrect, onWrong, onHint, onEnd }) {
    ...
    function placeAnchors() {
      anchorMeshes = anchors.flatMap((rawA, idx) => {
        ...
        // Zone de visée agrandie et quasi invisible (mais raycastable),
        // plus grande que le panneau réel — sinon il faut toucher pile
        // sa fine surface à 4-7 m, d'où les nombreux taps sans effet.
