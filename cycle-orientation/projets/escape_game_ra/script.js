...
(function ensureGameScreen() {
  ...
  const dossierBtn = el("button", "dossier-btn", "🗂️");
  ...
  if (p.type === "jigsaw-image") {
    ...
    function onTileClick(slot) {
      ...
      if (order.every((v, i) => v === i)) {
        ...
        setTimeout(() => {
          container.innerHTML = "";
          container.appendChild(el("div", "chapter-text", "<strong>La carte confirme : vous êtes à Genève. Cherchez l'écusson de la ville dans la salle — méfiez-vous des autres cantons.</strong>"));
