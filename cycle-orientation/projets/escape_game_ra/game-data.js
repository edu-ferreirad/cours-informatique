...
const CHAPTERS = [
  ...
  // ---------------------------------------------------------------- CH 6
  {
    ...
    narrative: [
      ...
      "À l'intérieur : la chanson « Cé qu'è lainô », en patois genevois, chantée chaque année lors de la Course de l'Escalade. Deux lettres « a » y sont mystérieusement entourées. Un calcul, griffonné dans la marge, doit vous indiquer où chercher."
    ],
    puzzle: {
      type: "calc",
      unlockCode: "3852",
      expression: "(4 × 7) ÷ 2",
      expected: 14,
      prompt: "Explorez la salle en réalité augmentée pour trouver la boîte, entrez le code, puis résolvez le calcul griffonné dans la marge. Le résultat est le numéro de la strophe à retrouver sur le panneau."
    },
    scan: null,
    spatialKey: "ch6",
    gateHint: "Cherchez une boîte fermée par un cadenas à chiffres.",
    answers: ["14", "strophe 14", "la strophe 14"],
    hint: "Le code est celui noté sur le bulletin de Clément Clé. Pour le calcul : (4 × 7) = 28, puis 28 ÷ 2 = 14.",
  ...
  // ---------------------------------------------------------------- CH 7
  {
    ...
    scan: null,
    spatialKey: "ch7",
    gateHint: "Cherchez le calendrier, sur le côté de l'armoire.",
