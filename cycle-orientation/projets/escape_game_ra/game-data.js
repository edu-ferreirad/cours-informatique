...
const CHAPTERS = [
  ...
  // ---------------------------------------------------------------- CH 3
  {
    ...
    puzzle: {
      type: "mirror",
      mirrorText: "S = XIX",
      prompt: "Le message du garde a été inversé pour brouiller les espions. Lisez-le à l'aide d'un miroir (n'importe lequel — un petit miroir de poche suffit), puis convertissez le chiffre romain en lettre (A=I, B=II, C=III… — le porte-documents 🗂️ peut vous aider).",
      followup: "La lettre trouvée est l'initiale de ce qui a résonné dans tout Genève cette nuit-là. Une fois le mot trouvé, confirmez-le en le retrouvant dans la salle."
    },
    scan: null,
