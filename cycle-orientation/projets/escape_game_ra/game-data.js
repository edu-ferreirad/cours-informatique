...
const CHAPTERS = [
  ...
  // ---------------------------------------------------------------- CH 1
  {
    ...
    puzzle: {
      type: "cipher",
      prompt: "Le mot est griffonné en chiffres au dos de la carte (1=A, 2=B, 3=C…). Complétez chaque case avec la bonne lettre pour reconstituer le nom de la ville.",
      numbers: [7, 5, 14, 5, 22, 5],
    },
    scan: null,
