...
const CALIBRATION_POINT_DESC =
  "Tenez-vous sur le seuil de la porte, près de l'armoire grise.";
...
const SPATIAL_ANCHORS = {
  ...
  salle_noire: [
    { id: "sens_vue",     emoji: "👁️", label: "La vue",     distance: 1.6, angle: 200, height: ARMOIRE_H },
    { id: "sens_toucher", emoji: "✋", label: "Le toucher", distance: 1.8, angle: 220, height: ARMOIRE_H },
    { id: "sens_ouie",    emoji: "👂", label: "L'ouïe",     distance: 2.0, angle: 240, height: ARMOIRE_H },
    { id: "sens_odorat",  emoji: "👃", label: "L'odorat",   distance: 1.7, angle: 260, height: ARMOIRE_H },
    { id: "sens_gout",    emoji: "👄", label: "Le goût",    distance: 1.9, angle: 280, height: ARMOIRE_H },
  ],
