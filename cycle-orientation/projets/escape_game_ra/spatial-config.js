...
const SPATIAL_ANCHORS = {
  ...
  ch2: [
    { id: "echelle_vraie",    label: "Cahier « Les échelles » (le vrai)",         correct: true,  distance: 0.5, angle: 100, height: DESK_H },
    { id: "echelle_fausse",   label: "Cahier « Les échelles » (faux exemplaire)", correct: false, distance: 1.6, angle: 87,  height: DESK_H },
    { id: "cahier_ascenseur", label: "Cahier « Ascenseurs »",                     correct: false, distance: 4.8, angle: 137, height: DESK_H },
    { id: "cahier_escaliers", label: "Cahier « Les escaliers »",                  correct: false, distance: 2.8, angle: 91,  height: DESK_H },
  ],
  ...
  ch6: [
    ...
    { id: "vieux_cahier",    label: "Un vieux cahier sans rapport",    correct: false, distance: 6.0, angle: 105, height: DESK_H },
  ],
