...
const SPATIAL_ANCHORS = {
  ...
  ch3_confirm: [
    ...
    { id: "alarme_incendie", assetKey: "img_alarme_incendie", label: "Une alarme incendie",  correct: false, distance: 4.2, angle: 80,  height: DESK_H, romanTrap: true },
    { id: "alarme",          assetKey: "img_alarme",          label: "Une sirène d'alarme",  correct: false, distance: 6.0, angle: 105, height: DESK_H, romanTrap: true },
  ],
  ...
  // ---- Chapitre 6 (suite) : une fois la boîte ouverte, l'élève doit
  // encore trouver le tableau où est punaisé "Cé qu'è lainô" (mentionné au
  // plan, hauteur 1m/largeur 2m — jamais utilisé jusqu'ici). C'est en le
  // zoomant qu'apparaît la vraie photo de la strophe 14 fournie par
  // l'enseignant (A déjà entourés dessus).
  ch6_song: [
    { id: "chanson_panneau", assetKey: "img_cequelaino_strophe14", emoji: "📜", label: "Un vieux panneau", correct: true, distance: 2.0, angle: 200, height: ARMOIRE_H },
  ],
  ...
  ch7: [
    { id: "calendrier_11_novembre", emoji: "📅", label: "Le calendrier — 11 novembre", correct: true,  distance: 1.865, angle: 220, height: ARMOIRE_H },
    { id: "calendrier_4_novembre",  emoji: "📅", label: "Le calendrier — 4 novembre",  correct: false, distance: 1.865, angle: 195, height: ARMOIRE_H, romanTrap: true },
    { id: "calendrier_18_novembre", emoji: "📅", label: "Le calendrier — 18 novembre", correct: false, distance: 1.865, angle: 245, height: ARMOIRE_H, romanTrap: true },
    { id: "verre_dommage_3", emoji: "🥃", label: "Un verre",        correct: false, distance: 4.2, angle: 80,  height: DESK_H },
  ],

  // ---- Bonus "Salle noire" : les 5 icônes des sens, trouvables en RA une
  // fois l'obscurité détectée (voir renderSalleNoireSenses). Rapprochées
  // (peu d'éléments dans la salle) — tous les cinq apparaissent ensemble,
  // dans n'importe quel ordre, via le mode "plusieurs trouvailles" de
  // exploreChapter (multiFind), pas via onCorrect/onWrong classique.
  salle_noire: [
    { id: "sens_vue",     emoji: "👁️", label: "La vue",     distance: 5.4, angle: 30,  height: DESK_H },
    { id: "sens_toucher", emoji: "✋", label: "Le toucher", distance: 2.3, angle: 340, height: PROF_H },
    { id: "sens_ouie",    emoji: "👂", label: "L'ouïe",     distance: 4.1, angle: 150, height: ARMOIRE_H },
    { id: "sens_odorat",  emoji: "👃", label: "L'odorat",   distance: 6.2, angle: 95,  height: DESK_H },
    { id: "sens_gout",    emoji: "👄", label: "Le goût",    distance: 1.4, angle: 210, height: PROF_H },
  ],
