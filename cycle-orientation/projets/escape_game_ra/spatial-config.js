...
const SPATIAL_ANCHORS = {
  ...
  ch2: [
    ...
    { id: "echelle_fausse",   assetKey: "img_echelle",    label: "Cahier « Les échelles »",   correct: false, distance: 1.6, angle: 87,  height: DESK_H },
  ...
  ch3: [
    { id: "miroir_cloche", emoji: "🪞", label: "Le miroir + l'écusson de Genève", correct: true,  distance: 6.7, angle: 116, height: DESK_H },
    { id: "verre_1",       emoji: "🥃", label: "Un verre",                        correct: false, distance: 4.2, angle: 80,  height: DESK_H },
    { id: "verre_2",       emoji: "🥃", label: "Un verre",                        correct: false, distance: 6.0, angle: 105, height: DESK_H },
  ],
  ...
  ch4: [
    ...
    { id: "boite_cadenas", emoji: "🔒", label: "Une boîte à cadenas",                    correct: false, distance: 3.0, angle: 180, height: ARMOIRE_H },
  ...
  ch6: [
    { id: "panneau_chanson", emoji: "🎵", label: "Panneau « Cé qu'è lainô »",       correct: true,  distance: 3.4, angle: 90,  height: PANNEAU_H },
  ...
  ch8: [
    { id: "bulletins", emoji: "📋", label: "Les bulletins de notes — bureau du professeur", correct: true, distance: 4.8, angle: 155, height: PROF_H },
  ],
};
