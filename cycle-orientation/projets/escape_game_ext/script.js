...
const STEPS = [
  ...
  },
  {
    ...
    question: "Quel objet leur a permis d'escalader la muraille ?",
    answer: "ECHELLE",
    photoRequired: true,
    photoQuestion: "Prenez en photo la façade de la Maison Tavel pour valider votre passage.",
  ...
  },
  {
    ...
    transition: "Effectivement, c'est bien grâce aux cloches de la ville que les citoyens ont pu être alertés. L'alarme est donnée vers 4h30. Hommes et femmes se lèvent ensemble, saisissent des armes et, en chemise de nuit, viennent prêter main-forte aux troupes de défense. Voici notre première héroïne.",
    ...
    question: "Notez le nom complet de cette héroïne.",
    answer: "MERE ROYAUME",
    altAnswers: ["DAME ROYAUME", "CATHERINE ROYAUME", "ROYAUME"],
    photoRequired: true,
    photoQuestion: "Prenez en photo la tour dite « de l'Escalade », au 7 rue de la Corraterie, pour valider votre passage.",
  ...
  },
  {
    ...
    question: "Je rentre toujours en premier, et je sors toujours en dernier : quel est cet objet ?",
    answer: "CLE",
    altAnswers: ["UNE CLE", "LA CLE"],
    photoRequired: true,
    photoQuestion: "Prenez en photo l'entrée du Passage de la Petite-Corraterie pour valider votre passage.",
  ...
  },
  {
    ...
    photoRequired: true,
    photoQuestion: "Prenez en photo les canons sous les arcades de l'Ancien Arsenal pour valider votre passage.",
...
function onStepSuccess(section, step) {
  ...
  // ---- Passage au secteur suivant : toujours sur clic manuel, jamais
  // automatique. Un secteur validé peut avoir des extras facultatifs
  // (bonus, digression, mini-jeu) à explorer avant de continuer — un
  // passage automatique les faisait disparaître avant que l'équipe
  // ait pu les utiliser. ----
  const continueBtn = document.createElement("button");
  continueBtn.type = "button";
  continueBtn.className = "validate-btn continue-to-next-btn";
  continueBtn.textContent = "▶ Continuer vers le secteur suivant";
...
function renderSlidingPuzzle(step, container) {
  ...
  function setupPuzzleGrid() {
    ...
    function renderTiles() {
      grid.innerHTML = "";
      tiles.length = 0; // sinon les tuiles des rendus précédents s'accumulent
                          // et handleTileClick finit par cibler une tuile fantôme
