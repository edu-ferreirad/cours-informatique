...
| 5 | Clé (Piaget, charade) | Passage de Monetier, Rue du Perron 19 | 46.2015, 6.1484 | Lieu réel, coordonnées **non géocodées** — estimation. ⚠ Voir note ci-dessous |
...
géolocalisée précise ; les autres (Treille, Monetier, Arsenal)
restent des estimations raisonnables mais non géocodées — **à
vérifier sur place avant la sortie**, comme les autres.

**⚠ Point trouvé en cherchant, à vérifier vous-même** : une source
historique (histoire-et-historiettes.ch) situe l'épisode de la clé de
Dame Piaget au « passage de la Petite-Corraterie », tout près de la
tour de la Corraterie elle-même — pas au Passage de Monetier (Rue du
Perron) comme je l'avais trouvé précédemment. Les deux passages sont
mentionnés dans des sources qui semblent sérieuses ; je n'ai pas pu
trancher avec certitude laquelle est la plus fiable. Si vous avez le
temps, ça vaut le coup de vérifier avant de figer le parcours.
